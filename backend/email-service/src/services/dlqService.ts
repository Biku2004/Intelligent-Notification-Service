/**
 * Dead Letter Queue (DLQ) Service for Email Delivery
 * Handles failed email notifications
 */
...
/**
 * Send failed email notification to Dead Letter Queue
 */
export async function sendToDLQ(
  ...
  try {
    ...
    console.log(`📮 Sent to DLQ: EMAIL notification for ${event.targetId}`);
  } catch (error) {
